...
df_data[1].to_csv("Data1.csv")
df_data[2].to_csv("Data2.csv")
df_data[3].to_csv("Data3.csv")
df_data[4].to_csv("Data4.csv")
df_data[5].to_csv("Data5.csv")
df_data[6].to_csv("Data6.csv")
df_data[7].to_csv("Data7.csv")
df_data[8].to_csv("Data8.csv")
df_data[9].to_csv("Data9.csv")
df_data[10].to_csv("Data10.csv")
